    ...
    <div class="mx-auto" style="width: 1440px; height: 170px;">
        <div class="d-flex justify-content-between align-items-center h-75 border-bottom border-3 border-secondary">
            ...
            <div class="col-2 fw-bold">
                <div>문의 : AJHGood@naver.com</div>
                <div>평일 : 10:00 ~ 17:00</div>
                <div>토·일요일, 공휴일 휴무</div>
            </div>
        </div>
        <div class="h-25 fw-bold d-flex align-items-center">
            Copyright ⓒ WIZIAN_B Institute of Korea. All Rights Reserved.
        </div>
    </div>
</div>
</body>
