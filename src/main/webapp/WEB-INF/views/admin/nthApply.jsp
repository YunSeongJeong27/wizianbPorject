    ...
    <div class="row">
        ...
        <div id="mainTab" class="col"
            ...
            <ul role="tablist" class="nav nav-tabs">
                <li role="presentation" tabindex="0" class="nav-item">
                ...
                <li role="presentation" tabindex="-1" class="nav-item">
            ...
            <div class="tab-content" id="myTabContent">
                <div id="tab1" aria-labelledby="btn_tab1" role="tabpanel"
                     class="tab-pane fade show active" aria-hidden="false">
                ...
                <div id="tab2" aria-labelledby="btn_tab2" role="tabpanel"
                     class="tab-pane fade" aria-hidden="false">
                    <!-- 탭2 그리드1 -->
                ...
                <div id="tab3" aria-labelledby="btn_tab3" role="tabpanel"
                    ...
                    <div style="height: 1185px;">
                        <div class="div_wrap_title">
                            ...
                            <div class="align_right">
                                <button id="btn_tab3_grid1_modify" class="btn-default"
                                        onclick="fn_tab3_grid1_modify_onclick()">수정
                                </button>
                                <button id="btn_tab3_grid1_save" class="btn-default" disabled=""
                    ...
                    <div style="height: 1185px;">
                        <div class="div_wrap_title">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td></td>
                                    <td class="align_right"><label
                                            for="slt_tab4_arg1_lang_tp">언어유형구분</label>
                                    </td>
                                    <td><select id="slt_tab4_arg1_lang_tp" class="slt_default auto_combo"
                                                style="display: none;">
                                        <option value="10">한국어</option>
                                        <option value="20">지원어</option>
                                    </select><span class="custom-combobox"><input title=""
                                                                                  id="auto_slt_tab4_arg1_lang_tp"
                                                                                  class="auto_slt_tab4_arg1_lang_tp custom-combobox-input ui-widget ui-widget-content ui-state-default ui-corner-left ui-autocomplete-input"
                                                                                  autocomplete="off"><a
                                            tabindex="-1"
                                            ...
                                            class="ui-button-icon-space"> </span></a></span></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div style="height: 1185px;">
                        <div class="div_wrap_title">
                            ...
                            <div class="align_right">
                                ...
                                <button id="btn_tab5_new" class="btn-default"
                                        onclick="fn_tab6_new_onclick()">신규
                                </button>
                                <button id="btn_tab5_save" class="btn-default"
