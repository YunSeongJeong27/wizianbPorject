           ...
           <div class="w-100">
                ...
                <div class="d-none animate__animated">
                    ...
                    <div class="ms-4">
                        ...
                        <div class="ms-4 d-none animate__animated">
                            <div class="px-2 py-1 mt-1 w-100 btn-lf text-start btn" onclick="index('interviewPass')">서류전형합격사정</div>
                            <div class="px-2 py-1 mt-1 w-100 btn-lf text-start btn" onclick="index('applicationPass')">면접전형합격사정</div>
                            <div class="px-2 py-1 mt-1 w-100 btn-lf text-start btn" onclick="index('finalPass')">최종합격자명부</div>
                            <div class="px-2 py-1 mt-1 w-100 btn-lf text-start btn" onclick="index('evaluationResults')">평가결과등록</div>
                        </div>
                    </div>
                </div>
            </div>
