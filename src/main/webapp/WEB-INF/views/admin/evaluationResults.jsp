            ...
            <div class="h-50">
                <div class="col-12 d-flex flex-row searchResult mt-4 mb-2">
                    <div class="col-7 d-flex flex-row align-items-center">
                        <p class="subTitle fw-bold me-2">심사결과등록</p>
                        <p class="subResult text-secondary me-2">검색결과:00건</p>
                        <div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            const data = [
                {
                    ...
                    nthEvaluationInfo:[{
                        ...
                        NAME_KOR:'NAME_KOR',    //성명
                        EV_PDF_FILE_NO:'EV_PDF_FILE_NO', //평가용지원서PDF파일번호
                        /*EV_SCORE:'EV_SCORE',//평가점수*/
                        DOC_PASS_YN:'DOC_PASS_YN',//서류전형적격여부
                        EV1_SCORE: 'EV1_SCORE',     // 문항1 평가점수
                        EV2_SCORE: 'EV2_SCORE',     // 문항2 평가점수
                        EV3_SCORE: 'EV3_SCORE',     // 문항3 평가점수
                        NOTE:'NOTE' //비고

                    },
                    {
                        APLY_NO:'APLY_NO22',   //지원번호
                        NAME_KOR:'NAME_KOR22',    //성명
                        EV_PDF_FILE_NO:'EV_PDF_FILE_NO22', //평가용지원서PDF파일번호
                        /*EV_SCORE:'EV_SCORE',//평가점수*/
                        DOC_PASS_YN:'DOC_PASS_YN22',//서류전형적격여부
                        EV1_SCORE: 'EV1_SCORE22',     // 문항1 평가점수
                        EV2_SCORE: 'EV2_SCORE22',     // 문항2 평가점수
                        EV3_SCORE: 'EV3_SCORE22',     // 문항3 평가점수
                        NOTE:'NOTE22' //비고
                ...
                },
                {
                    ...
                    nthEvaluationInfo:[{
                    ...
                    },
                        {
                            ...
                            NAME_KOR:'NAME_KOR33',    //성명
                            EV_PDF_FILE_NO:'EV_PDF_FILE_NO33', //평가용지원서PDF파일번호
                            /*EV_SCORE:'EV_SCORE',//평가점수*/
                            DOC_PASS_YN:'DOC_PASS_YN33',//서류전형적격여부
                            EV1_SCORE: 'EV1_SCORE33',     // 문항1 평가점수
                            EV2_SCORE: 'EV2_SCORE33',     // 문항2 평가점수
                            EV3_SCORE: 'EV3_SCORE33',     // 문항3 평가점수
                            NOTE:'NOTE33' //비고
            ...
            const nthEvaluationTable = new tui.Grid({
                ...
                onGridMounted() {
                    nthEvaluationTable.focus(0, 'COURSE_DIV', true);
                    subTableLoad(0);
                }
            });
            ...
            function subTableLoad(rowKey){
                ...
                const nthEvaluationRegistTable = new tui.Grid({
                    ...
                    // 처음 grid 렌더링 시 첫번째 row에 focus 및 하단 테이블에 데이터 load
                    onGridMounted() {
                        nthEvaluationRegistTable.focus(0, 'APLY_NO', true);
                    }
                });
