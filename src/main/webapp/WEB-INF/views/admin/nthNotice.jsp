...
<div class="container-table m-2">
    <div class="col-12">
        ...
        <div class="d-flex flex-row justify-content-between mt-4 h-100">
                ...
                <div class="searchResult">
                    <div class="d-flex flex-row justify-content-between mb-2">
                        <div class="d-flex flex-row align-items-center">
                            ...
                            <p id="searchResult" class="subResult text-secondary me-2">검색결과: 0건</p>
            ...
            <div class="w-100">
                <div class="searchResult d-flex flex-row justify-content-between align-items-center"
                     style="height: 32.38px">
                    <p class="subTitle fw-bold">안내문내용</p>
                    <button id="noticeInsertContentBtn" class="btn btn-sm btn-light btn-outline-dark"
                            data-bs-toggle="modal" data-bs-target="#noticeModal">안내문작성하기
                    </button>
                </div>
                ...
                <div id="noticeInfoTable" class="text-start mb-3 mt-2">
                    <div class="border border-gray-100 rounded-2 mb-2">
                        <div class="d-flex flex-row align-items-center border-bottom border-gray-100">
                            <div class="col-2 fw-bold inputTitle d-flex align-items-center ps-2 fw-bold inputTitle">
                                메일제목
                            </div>
                            <div class="col-10 p-2"><input class="form-control tableInput" type="text" name="SUBJECT"
                                                           value=""></div>
                        </div>
                        <div class="d-flex flex-row align-items-center">
                            <div class="col-2 fw-bold inputTitle d-flex align-items-center ps-2 fw-bold inputTitle">
                            ...
                            <div class="col-10 p-2 d-flex flex-row align-items-center">
                                ...
                                <label for="addFile" class="ms-3" style="width: 4%; font-size: 20px;"><i
                ...
                <form action="#" method="post">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <input type="button" class="btn btn-outline-secondary p-1 px-2 mx-1 fw-bold"
                                   data-bs-dismiss="modal" value="닫기">
                        </div>
                    </div>
                    <div class="mt-3">
                        <div id="editor"></div>
...
<script>
    ...
    function subTableLoad(rowKey) {
        ...
        // 검색결과 (테스트) 추후 보완
        const test = document.querySelector('#searchResult');
        test.innerHTML = "검색결과 : " + noticeData.length + "건"

        //setPerPage 핸들러(value, 진수)
        ...
        const perPageSelect = document.getElementById('noticeTablePage');
        ...
        document.getElementById("noticeInsertBtn").addEventListener("click", function () {
            ...
            noticeTable.prependRow(rowData[0], {
